...
public class LangC : TestGenerator.Shared.Plugin
{
    ...
    public static Logger Logger { get; } = Injector.Inject<IAppService>().GetLogger("C / C++");
    ...
    public LangC()
    {
        ...
        [
            new BuildType
            {
                ...
                [
                    ...
                    new FilesField(_projectsService.Current.Path, [".c", ".h"]) { Key = "files" }
                ]
            }
        ];
        ProjectTypes =
        [
            new ProjectType("C", "C", CIcon, [
        ...
        FileIcons[".c"] = CIcon;
        FileIcons[".h"] = HIcon;
        RegexFileIcons[new Regex(@"[/\\]CMakeLists\.txt$")] =
            "M21.2 20.4H2.8L8.7 15.4L21.2 20.4Z M21.75 20.15L13.9 17L12.5 1.89999L21.75 20.15Z M13 11.2L2.89999 19.7L12.1 1.5L13 11.2Z";
        RegexFileIcons[new Regex(@"[/\\]cmake-build-\w+$")] =
