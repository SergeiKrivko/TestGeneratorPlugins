...
public class LangPython : TestGenerator.Shared.Plugin
{
    ...
    public LangPython()
    {
        ...
        ProjectTypes =
        [
            new ProjectType("Python", "Python", PythonIcon, [
                new ProjectType.ProjectTypeDetector(7, path => File.Exists(Path.Join(path, "main.py"))),
        ...
        [
            ...
            ], SettingsPageType.ProjectSettings, () => _projectsService.Current.Type == ProjectTypes[0])
        ];
